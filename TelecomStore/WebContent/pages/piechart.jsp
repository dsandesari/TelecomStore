...
<%@page import="com.tcs.ilp.telecomstore.module3.dto.OrderDetailsBean,java.util.ArrayList,com.tcs.ilp.telecomstore.module3.dao.PieChartDAO,com.tcs.ilp.telecomstore.module3.controller.PieChartServ" %> 
<%@ page  import="java.awt.image.BufferedImage,java.awt.image.RenderedImage,javax.imageio.ImageIO" %>
	...
	<div id="templatemo_content_container">
        <div id="templatemo_content">
            <div id="templatemo_content_left">
                ...
                <h3><center>PieChart</center></h3>
                
 
<%
try{
ChartRenderingInfo info = new ChartRenderingInfo();
JFreeChart jchart = (JFreeChart)session.getAttribute("Chart");
jchart.createBufferedImage(500,400,info);
String imageMap=ChartUtilities.getImageMap("MyImageMap",info);
...
<IMG SRC="<%=request.getContextPath()%>/PieChartServ" usemap="#MyImageMap" width="500" height="400"/>
</center> 
...
<center><a href="<%=request.getContextPath() %>/pages/Menu.jsp">Back to Menu</a></center>
                </div>
                </div> <!-- end of one post -->
