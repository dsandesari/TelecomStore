...
<%@page import="com.tcs.ilp.telecomstore.module3.dto.OrderDetailsBean,java.util.ArrayList" %> 
<%ArrayList<OrderDetailsBean> list=(ArrayList<OrderDetailsBean>)request.getAttribute("finallist"); %>   
<%@ page language="java" %>
	...
	<div id="templatemo_content_container">
        <div id="templatemo_content">
            <div id="templatemo_content_left">
                ...
                <h3><center>List Of Orders</center></h3>
        <h4> <center> <a href="<%=request.getContextPath() %>/pages/piechart.jsp"> View PieChart</a></center> </h4>    
...
<%for(OrderDetailsBean obj:list) {%>
<tr align="center">
<td><%=obj.getOrder_id() %></td>
<td><%=obj.getOrder_date() %></td>
<td><%=obj.getOrder_amount() %></td>
<td><%=obj.getProduct_status() %></td></tr>
<%} %>
</table>
