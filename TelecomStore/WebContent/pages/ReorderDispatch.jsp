...
<center>
<h3>The status of order <%=ord %> is <%=status %>.To request for defective items order must be first acknowledged.</h3>
<br>
<br></br>
<center><a href="<%=request.getContextPath() %>/pages/Acknowledge.jsp">Please click here if you want to acknowledge your order</a></center>
</center>
                </div>
                </div> <!-- end of one post -->
