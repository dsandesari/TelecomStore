...
<form name="f1" method="post" action="<%=request.getContextPath() %>/RetailerController" onsubmit="return cancel_orderId_validateForm()">
<center>
<h3 align="center">Enter the order Id to cancel the order</h3>
<table align="center">
<tr>
...
<tr></tr>
<tr>
	<td><input type="hidden" name="index" value="cancel">
	<input type="submit" value="CancelOrder" name="check" ></td>
	<td>
