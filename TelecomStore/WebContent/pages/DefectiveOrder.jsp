...
<body onload="OrderId_firstFocus()">
	...
	<div id="templatemo_content_container">
        <div id="templatemo_content">
            <div id="templatemo_content_left">
				<h2>Reorder Defective Products</h2>
                <div class="templatemo_post" style="font-color:white;">
                	<form name="f1" method="post" action="<%=request.getContextPath() %>/RetailerController" onsubmit="return orderId_validateForm()">

<h3 align="center">Enter the order Id to request for defective items</h3>
<center>
<table align="center">
<tr>
	<td>Order ID:</td><td><input type="text" name="orderid" size="10" maxlength="5"></td>
</tr>
<tr></tr>
<tr>
	<td>
...
<input type="hidden" name="key" value="first">
<input type="hidden" name="index" value="defectid">
