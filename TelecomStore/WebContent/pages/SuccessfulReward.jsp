...
int reward=(Integer)request.getAttribute("rewardid");
//int oid=Integer.parseInt(order);
//OrderDAO  ob1=new OrderDAO();
//float price=ob1.getPrice(order);
float price=(Float)request.getAttribute("prc");
%>
<%@ page language="java" %>
...
<body>
	...
	<div id="templatemo_content_container">
       ...
       <center>         <h3>Order has been Successfully placed</h3>
<br>
<h2>Order Id is <%=order %></h2><br>
<h2>Total cost is <%=price %></h2>
<h2>Reward Id is <%=reward%></h2>
<br>
