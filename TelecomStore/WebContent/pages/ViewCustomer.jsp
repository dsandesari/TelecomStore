<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@page import="java.util.ArrayList,com.tcs.ilp.telecomstore.module3.dto.OrderShipmentBean,com.tcs.ilp.telecomstore.module3.dao.OrderShipmentDao" %>
    <%String ord=(String)request.getAttribute("or");
    int order_id=Integer.parseInt(ord);
    System.out.println(order_id);
    ArrayList<OrderShipmentBean>al= new ArrayList<OrderShipmentBean>();
   OrderShipmentDao ob=new OrderShipmentDao();
    al=(ArrayList<OrderShipmentBean>)ob.RetrieveCustomer(order_id); 
    %>
<%@ page language="java" %>
...
<form name="myform" action="<%=request.getContextPath() %>/RetailerController" method="post" target="_parent" onsubmit= "return customer_validateForm()">
<table align="center">
<% for(OrderShipmentBean obj:al){ %>
<tr>
	<td>Customer Name:</td><td><input type="text" name="customername" maxlength="20" value="<%=obj.getCust_name()%>" readonly="readonly"></input></td>
	</tr>
	
	<tr>
	<td>Shipment Address:<span><font color="red">*</font></span></td><td><textarea name="shipmentaddress" rows="2" cols="16" onKeyPress='return maxLength(this,"50");' ><%=obj.getAddress()%></textarea></td>
	</tr>
	<tr>
	<td>Contact Number:<span><font color="red">*</font></span></td><td><input type="text" name="contactno" maxlength="10" value="<%=obj.getPhno()%>" ></td>
	</tr>
	<tr>
	<td>Email ID:<span><font color="red">*</font></span></td><td><input type="text" name="email" maxlength="20" value="<%=obj.getEmail()%>"></td>
	</tr></table><%} %>
	<br>
	<input type="hidden" name="index" value="newdetails">
	<center><input type= "submit" name="check" value="Update"></center>
	<br>
	<font size="2">Fields marked with <span><font color="red">*</font></span> can be updated only.</font>
	
	<input type="hidden" name="hello" value="<%=order_id%>">
