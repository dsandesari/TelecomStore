<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
  ...
  <%@page import="java.util.ArrayList,com.tcs.ilp.telecomstore.module3.dao.OrderDAO,com.tcs.ilp.telecomstore.module3.dao.RetailerDAO,com.tcs.ilp.telecomstore.module3.dto.OrderProductBean" %>
<%String user=(String)session.getAttribute("uid"); 
ArrayList<OrderProductBean>shoplist=(ArrayList<OrderProductBean>)session.getAttribute("cart");%>
<%@ page language="java" %>
	...
	<div id="templatemo_content_container">
        <div id="templatemo_content">
            <div id="templatemo_content_left">
                ...
                <div class="templatemo_post" style="font-color:white;"><center>
                <br>
                <form name="f2" method="post" action="<%=request.getContextPath() %>/RetailerController" onsubmit="return quantity_validateForm()">
<%OrderDAO ob=new OrderDAO();
ob1=new RetailerDAO();
retailer_id=ob1.getRetailerID(user);
...
<td><%=obj.getQuantity()%></td></tr>
<% } %>
</table>
<br>
<h3>List Of products added to cart</h3>
<TABLE border="1" align="center">
<tr>
<th>PRODUCT MODELID</th>
<th>QUANTITY</th>
...
<% for(OrderProductBean obj:shoplist)
...
for(int l=0;l<an.size();l++) {
	...
	String prod=an.get(l).getProductname();
	
	//String ord=obs.getProductname();
	if(!(prod.equalsIgnoreCase(shoplist.get(k).getProductname()))){
		count++;
	}if((count==shoplist.size()))
			{
	
	%>
<option><%=an.get(l).getProductname()%></option>
...
%>
   ...
   Quantity <input type="text" name="q1" maxlength="3">
<br>
<table>
...
<td>
<input type="submit" name="check" value="BuyMoreProducts"></td></tr></table>
