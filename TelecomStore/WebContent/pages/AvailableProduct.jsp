<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%>
     <%@page import="java.util.*,com.tcs.ilp.telecomstore.module3.connect.ConnectionFactory,com.tcs.ilp.telecomstore.module3.dto.ProductBean"%>
    <% ArrayList<ProductBean>al=(ArrayList<ProductBean>)session.getAttribute("productinfo");%>
<%@ page language="java" %>
...
<% for(ProductBean ob:al){ %>
<tr>
<td><%=ob.getProductmodel_id() %></td>
<td><%=ob.getProductmodel_name() %></td>
<td><%=ob.getProductmodel_des() %></td>
<td><%=ob.getProductmodel_feature() %></td>
<td><%=ob.getPrice()%></td></tr>
<%}%>
</table>
<br>
