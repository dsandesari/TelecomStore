<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@page import="java.util.ArrayList,com.tcs.ilp.telecomstore.module3.dto.RewardsBean"%>
    <% ArrayList<RewardsBean>al=( ArrayList<RewardsBean>)session.getAttribute("rewardinfo");%>
<%@ page language="java" %>
...
<tr>
<td colspan="50">REWARD ID</td>

<td colspan="50">OFFERS</td>
<td colspan="50">REWARD DATE</td>
<td colspan="50">REWARD STATUS</td>
</tr>
<% for(RewardsBean ob:al){ %>
<tr>
<td colspan="50"><%=ob.getReward_id() %></td>

<td colspan="50"><%=ob.getOffers() %></td>
<td colspan="50"><%=ob.getReward_date() %></td>
<td colspan="50"><%=ob.getReward_status() %></td>
<% } %>
</table>
<br>
<br>
<a href="<%=request.getContextPath() %>/pages/Menu.jsp">Back to Menu</a></center>
                </div>
                </div> <!-- end of one post -->
