...
<body onload="Customer_firstFocus()">
	...
	<div id="templatemo_content_container">
        <div id="templatemo_content">
            <div id="templatemo_content_left">
                ...
                <br>
<center>                	<h2>Please fill the customer Details</h2>
<form name="myform" action="<%=request.getContextPath() %>/RetailerController" onsubmit= "return customer_validateForm()" method="post">

<table align="center">
	<tr>
	<td>Customer Name:<span><font color="red">*</font></span></td><td><input type="text" name="customername" maxlength="20"></td>
	</tr>
	<tr>
	<td>Shipment Address:<span><font color="red">*</font></span></td><td><textarea name="shipmentaddress" rows="2" cols="16" onKeyPress='return maxLength(this,"50");'></textarea></td>
	</tr>
	<tr>
	<td>Contact Number:<span><font color="red">*</font></span></td><td><input type="text" name="contactno" maxlength="10"></td>
	</tr>
	<tr>
	

<td>Email ID:<span><font color="red">*</font></span></td><td><input type="text" name="email" maxlength="20"></td>

</tr>
	<tr></tr>
	<tr>
	<td colspan="2"><center><input type= "submit"  name="check" value="submit"></center></td>
	</tr> 
	
</table>
<br>
<font size="2">fields marked with <span><font color="red">*</font></span> are mandatory</font>
<input type="hidden" name="index" value="customer">
</form>
</center>
                </div>
                </div> <!-- end of one post -->
