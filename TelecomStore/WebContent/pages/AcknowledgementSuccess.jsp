    ...
    <div id="templatemo_menu_panel">
    	<div id="templatemo_menu_section">
            <ul>
                ...
                <li><a href="<%=request.getContextPath()%>/pages/" target="_blank" style="border-right: 1px solid #660e4c;">About </a></li> 
...
<h3 align="center">Order with order id <%=ord%> has been successfully acknowledged</h3>
<br><br>
</br>
