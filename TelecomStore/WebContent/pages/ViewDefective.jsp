<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="com.tcs.ilp.telecomstore.module3.dao.OrderDAO,com.tcs.ilp.telecomstore.module3.dto.DefectiveProductBean,java.util.ArrayList" %>
    <% String ord=(String)request.getAttribute("or"); 
    int oid=Integer.parseInt(ord);
    System.out.println(oid);
    ArrayList<DefectiveProductBean>al=new ArrayList<DefectiveProductBean>();
    al=new OrderDAO().getProductCode(oid);
    %>
<%@ page language="java" %>
	...
	<div id="templatemo_content_container">
        <div id="templatemo_content">
            <div id="templatemo_content_left">
                ...
                <form name="defec" method="post" action="<%=request.getContextPath() %>/RetailerController" onsubmit="return checkbox_validate()">
<h3>Please select the defective product codes</h3>
<br>
<br>
<table>
<% for(DefectiveProductBean ob:al)
	{%>
	<tr>
	<td><input type="checkbox" name="code" value="<%=ob.getProductcode()%>" > <%=ob.getProductcode()%></td>
	...
	<input type="submit" value="Request for reorder" name="check">
		
	<input type="hidden" name="index" value="defectcode"></form>
                </div>
                </div> <!-- end of one post -->
