    ...
    <div id="templatemo_menu_panel">
    	<div id="templatemo_menu_section">
            <ul>
                ...
                <li><a href="<%=request.getContextPath()%>/pages/Aboutus.jsp" style="border-right: 1px solid #660e4c;">About </a></li> 
        ...
        <div id="templatemo_content">
            <div id="templatemo_content_left">
                ...
                <div class="templatemo_post" style="font-color:white;">
                	<table align="center">
                	<center>
<tr><td>Error: Enter the Quantity within range</td></tr>
<tr></tr>
<tr>
<td><a href="<%=request.getContextPath() %>/pages/Order.jsp">Click here to go to the previous page</a></td>
</tr>
</center>   
</table>
             </div>
